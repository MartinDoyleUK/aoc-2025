...
describe('logging functions', () => {
  ...
  describe('logPuzzleDay()', () => {
    ...
    it('should log puzzle day for double-digit day', () => {
      logPuzzleDay('25');
      expect(console.info).toHaveBeenCalledWith(expect.stringContaining('twenty-fifth'));
    });
  ...
  describe('logAnswer()', () => {
    it('should log answer with part number and time', () => {
      ...
      expect(console.info).toHaveBeenCalledWith(expect.stringContaining('First part'));
    ...
    it('should handle string answers', () => {
      ...
      expect(console.info).toHaveBeenCalledWith(expect.stringContaining('test answer'));
    });
    ...
    it('should handle expected as function that returns true', () => {
      ...
      logAnswer({ answer: 42, expected: verifyFn, partNum: 1, taskStartedAt: 0 });
      expect(console.info).toHaveBeenCalledWith(expect.stringContaining('✅'));
    });
    ...
    it('should handle expected as function that returns false', () => {
      ...
      logAnswer({ answer: 42, expected: verifyFn, partNum: 1, taskStartedAt: 0 });
      expect(console.info).toHaveBeenCalledWith(expect.stringContaining('❌'));
      expect(console.info).toHaveBeenCalledWith(expect.stringContaining('verify-function result'));
    });

    it('should handle part 2', () => {
      logAnswer({ answer: 42, partNum: 2, taskStartedAt: 0 });
      expect(console.info).toHaveBeenCalledWith(expect.stringContaining('Second part'));
    });
  });
  ...
  describe('logTime()', () => {
    it('should log time taken for a day', () => {
      logTime(0, '5');
      expect(console.info).toHaveBeenCalledWith(expect.stringContaining('five'));
      expect(console.info).toHaveBeenCalledWith(expect.stringContaining('Took'));
    });
  });
  ...
  describe('logComplete()', () => {
    it('should log completion message with time', () => {
      logComplete(0);
      expect(console.info).toHaveBeenCalledWith(expect.stringContaining('All completed'));
    });
  });
  ...
  describe('logStart()', () => {
    it('should log start message', () => {
      logStart();
      expect(console.info).toHaveBeenCalledWith(expect.stringContaining('Starting puzzle run'));
    });
  });
  ...
  describe('logError()', () => {
    it('should log error with label', () => {
      ...
      expect(console.info).toHaveBeenCalledWith(expect.stringContaining('Error label'), error);
    });

    it('should log error without error object', () => {
      logError('Error label');
      expect(console.info).toHaveBeenCalledWith(expect.stringContaining('Error label'), undefined);
    });
  });
